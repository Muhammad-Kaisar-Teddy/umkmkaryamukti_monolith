...
session_start();
// Koneksi ke database
$conn = new mysqli("sql105.infinityfree.com", "if0_38227943", "peninjawan123", "if0_38227943_sliderdb");
...
<body>
    ...
    <header class="header" style="display: flex;">
        <img src="assets/Logo_lamtim.png">
        <img src="assets/Logo_kkn.png">
        <div class="title-wrap text-left">
            ...
            <p class="subjudul" style="color:gray;">Produk</p>
        </div>
