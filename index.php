...
$user_db    = "if0_38227943";
$pass_db    = "peninjawan123";
$nama_db    = "if0_38227943_login";
...
<head>
    ...
    <style>
        ...
        body, html {
            ...
            background: url('assets/background_login_page.jpg') no-repeat center center fixed;
...
<div class="section_login">
    <div class="login-box">
        ...
        <div class="login-right">
            <h2>Akses Untuk Operator</h2>
            <p>Hanya Pihak Berwenang<br>Silahkan Verifikasi Diri</p>
        </div>
    </div>
</div>
...
<footer class="footer-front">
            <div class="footer-content">
                <div class="footer-left">
                    ...
                    <p>34382<br />Desa Karyamukti, Kecamatan Sekampung, Kabupaten Lampung Timur, Lampung</p>
                    <p>Big Thanks to Tubes-KSI-Lebungfarm Team and KKN 2025 ITERA Group 97</p>
                </div>
