...
<body>
    ...
    <header class="header" style="display: flex;">
        ...
        <div class="title-wrap text-left">
            ...
            <p class="subjudul" style="color:gray;">Monitoring Pengunjung</p>
        </div>
    ...
    <div class="content" id="top">
        ...
        <?php
        // Koneksi ke database
        $conn = new mysqli("sql105.infinityfree.com", "if0_38227943", "peninjawan123", "if0_38227943_monitoring_db");
