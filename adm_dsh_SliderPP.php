...
$conn = new mysqli("sql105.infinityfree.com", "if0_38227943", "peninjawan123", "if0_38227943_slider_pp");
...
if (isset($_POST['add'])) {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        echo "File berhasil diunggah: " . $target_file;
    } else {
        echo "Gagal mengunggah file.";
    }
        
    $sql = "INSERT INTO sliders (slider_group, image_url) VALUES ('$group', '$target_file')";
